...
{: .warning }
This validation constraint is deprecated and will be removed in v8.0. Use Symfony's own [Json](https://symfony.com/doc/7.1/reference/constraints/Json.html) validation
constraint instead, which is introduced in Symfony 4.3.

Applies to:

* [properties](http://symfony.com/doc/7.1/validation.html#properties)
* [methods](http://symfony.com/doc/7.1/validation.html#getters)
