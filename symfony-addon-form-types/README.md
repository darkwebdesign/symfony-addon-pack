...
[![Build Status](https://travis-ci.org/darkwebdesign/symfony-addon-form-types.svg?branch=4.4)](https://travis-ci.org/darkwebdesign/symfony-addon-form-types?branch=4.4)
[![Coverage Status](https://codecov.io/gh/darkwebdesign/symfony-addon-form-types/branch/4.4/graph/badge.svg)](https://codecov.io/gh/darkwebdesign/symfony-addon-form-types)
...
Learn more about it in its [documentation](https://github.com/darkwebdesign/symfony-addon-pack/blob/4.4/doc/reference/forms/types/index.md).
