...
[![Build Status](https://travis-ci.org/darkwebdesign/symfony-addon-form-types.svg?branch=3.2)](https://travis-ci.org/darkwebdesign/symfony-addon-form-types?branch=3.2)
[![Coverage Status](https://codecov.io/gh/darkwebdesign/symfony-addon-form-types/branch/3.2/graph/badge.svg)](https://codecov.io/gh/darkwebdesign/symfony-addon-form-types)
...
Learn more about it in its [documentation](https://github.com/darkwebdesign/symfony-addon-pack/blob/3.2/doc/reference/forms/types/index.md).
