...
[![Build Status](https://travis-ci.org/darkwebdesign/symfony-addon-pack.svg?branch=4.0)](https://travis-ci.org/darkwebdesign/symfony-addon-pack?branch=4.0)
[![Coverage Status](https://codecov.io/gh/darkwebdesign/symfony-addon-pack/branch/4.0/graph/badge.svg)](https://codecov.io/gh/darkwebdesign/symfony-addon-pack)
...
Learn more about it in its [documentation](https://github.com/darkwebdesign/symfony-addon-pack/blob/4.0/doc/index.md).
